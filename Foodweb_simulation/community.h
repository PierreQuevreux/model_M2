...
private :
    ...
    double _meanRecy[2]; // average amount of nutrients recycled by primary and secondary producers
    double _connectance;
    double _TLmax; // maximal TL
    double _meanCV; // average coefficient of variation of organisms
